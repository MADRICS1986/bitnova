...
=======
class VersionBitsWarningTest(BitNovaTestFramework):
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
        # Stop-start the node. This is required because bitnovad will only warn once about unknown versions or unknown rules activating.
>>>>>>> 5360f2baff (Initialized BitNova project)
        self.restart_node(0)
