...
=======
    from `BitNovaTestFramework` or `P2PInterface` class ensures the timeout is
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
    write_config(os.path.join(datadir, "bitnova.conf"), n=n, chain=chain, disable_autoconnect=disable_autoconnect)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
<<<<<<< HEAD
        ...
        if platform.system() == "Darwin":
            ...
            datadir = temp_dir / ".bitcoin"
=======
        datadir = temp_dir / "BitNova"
    else:
        env = dict(HOME=str(temp_dir))
        if platform.system() == "Darwin":
            datadir = temp_dir / "Library/Application Support/BitNova"
        else:
            datadir = temp_dir / ".bitnova"
>>>>>>> 5360f2baff (Initialized BitNova project)
    return env, datadir
...
=======
    with open(os.path.join(datadir, "bitnova.conf"), 'a', encoding='utf8') as f:
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
    if os.path.isfile(os.path.join(datadir, "bitnova.conf")):
        with open(os.path.join(datadir, "bitnova.conf"), 'r', encoding='utf8') as f:
>>>>>>> 5360f2baff (Initialized BitNova project)
            for line in f:
