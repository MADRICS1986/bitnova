...
=======
     See https://github.com/bitnova/bitnova/blob/master/doc/tracing.md#context-net
>>>>>>> 5360f2baff (Initialized BitNova project)
"""
...
=======
class NetTracepointTest(BitNovaTestFramework):
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
        self.log.info("connect a P2P test node to our bitnovad node")
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
        self.log.info("connect two P2P test nodes to our bitnovad node")
>>>>>>> 5360f2baff (Initialized BitNova project)
        testnodes = list()
...
=======
            f"connect {EXPECTED_OUTBOUND_CONNECTIONS} P2P test nodes to our bitnovad node")
>>>>>>> 5360f2baff (Initialized BitNova project)
        testnodes = list()
...
=======
            f"connect {MAX_INBOUND_CONNECTIONS + EXPECTED_EVICTED_CONNECTIONS} P2P test nodes to our bitnovad node and expect {EXPECTED_EVICTED_CONNECTIONS} evictions")
>>>>>>> 5360f2baff (Initialized BitNova project)
        testnodes = list()
...
=======
        self.log.info("connect a misbehaving P2P test nodes to our bitnovad node")
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
            f"connect {EXPECTED_CLOSED_CONNECTIONS} P2P test nodes to our bitnovad node")
>>>>>>> 5360f2baff (Initialized BitNova project)
        testnodes = list()
