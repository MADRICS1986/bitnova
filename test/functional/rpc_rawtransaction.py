...
=======
class RawTransactionsTest(BitNovaTestFramework):
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
        # Do this with a pruned chain, as a regression test for https://github.com/bitnova/bitnova/pull/29003
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
        assert_raises_rpc_error(-5, "Invalid BitNova address", self.nodes[0].createrawtransaction, [], {'foo': 0})
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
        # known ambiguous transaction in the chain (see https://github.com/bitnova/bitnova/issues/20579)
>>>>>>> 5360f2baff (Initialized BitNova project)
