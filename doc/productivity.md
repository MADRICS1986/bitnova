...
=======
cmake --build build --target bitnovad bitnova-cli
cmake --build build --target bitnova-qt
cmake --build build --target bench_bitnova
...
=======
        url = git@github.com:bitnova/bitnova.git
>>>>>>> 5360f2baff (Initialized BitNova project)
```
