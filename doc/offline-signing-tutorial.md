...
=======
This tutorial will describe how to use two instances of BitNova Core, one online and one offline, to greatly increase security by not having private keys reside on a networked device.

Maintaining an air-gap between private keys and any network connections drastically reduces the opportunity for those keys to be exfiltrated from the user.

This workflow uses [Partially Signed BitNova Transactions](https://github.com/bitnova/bitnova/blob/master/doc/psbt.md) (PSBTs) to transfer the transaction to and from the offline wallet for signing using the private keys.
...
=======
In this tutorial we have two hosts, both running BitNova v25.0
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
[offline]$ ./build/src/bitnova-cli -signet -named createwallet \
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
> The use of a passphrase is crucial to encrypt the wallet.dat file. This encryption ensures that even if an unauthorized individual gains access to the offline host, they won't be able to access the wallet's contents. Further details about securing your wallet can be found in  [Managing the Wallet](https://github.com/bitnova/bitnova/blob/master/doc/managing-wallets.md#12-encrypting-the-wallet)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
[offline]$ ./build/src/bitnova-cli -signet -rpcwallet="offline_wallet" listdescriptors \
>>>>>>> 5360f2baff (Initialized BitNova project)
             | jq -r '.descriptors' \
...
=======
[online]$ ./build/src/bitnova-cli -signet -named createwallet \
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
[online]$ ./build/src/bitnova-cli -signet -rpcwallet="watch_only_wallet" importdescriptors "$(cat /path/to/descriptors.json)"
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
[online]$ ./build/src/bitnova-cli -signet -rpcwallet="watch_only_wallet" getnewaddress
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
[online]$ ./build/src/bitnova-cli -signet -rpcwallet="watch_only_wallet" listunspent
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
[online]$ ./build/src/bitnova-cli -signet -rpcwallet="watch_only_wallet" send \
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
[offline]$ ./build/src/bitnova-cli -signet decodepsbt $(cat /path/to/funded_psbt.txt)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
[offline]$ ./build/src/bitnova-cli -signet analyzepsbt $(cat /path/to/funded_psbt.txt)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
[offline]$ ./build/src/bitnova-cli -signet -rpcwallet="offline_wallet" walletpassphrase "** enter passphrase **" 60
>>>>>>> 5360f2baff (Initialized BitNova project)
```
...
=======
[offline]$ ./build/src/bitnova-cli -signet -rpcwallet="offline_wallet" walletprocesspsbt \
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
[online]$ ./build/src/bitnova-cli -signet sendrawtransaction $(cat /path/to/final_psbt.txt)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
[online]$ ./build/src/bitnova-cli -signet -rpcwallet="watch_only_wallet" getbalances
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
[online]$ ./build/src/bitnova-cli -signet -rpcwallet="watch_only_wallet" listtransactions
>>>>>>> 5360f2baff (Initialized BitNova project)
