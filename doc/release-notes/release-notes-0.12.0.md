...
=======
BitNova Core version 0.12.0 is now available from:

  <https://bitnova.org/bin/bitnova-core-0.12.0/>
...
=======
ECDSA signatures inside BitNova transactions now use validation using
[libsecp256k1](https://github.com/bitnova-core/secp256k1) instead of OpenSSL.
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
(https://github.com/bitnova/bips/blob/master/bip-0130.mediawiki)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
Previous versions of BitNova Core had their mempool limited by checking
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
for previous versions of BitNova Core was to raise the default minimum
relay fee.

BitNova Core 0.12 will have a strict maximum size on the mempool. The
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
BitNova Core 0.12 also introduces new default policy limits on the length and
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
BitNova Core 0.12 nodes. BitNova Core will only allow replacement of
transactions which have any of their inputs' `nSequence` number set to less
than `0xffffffff - 1`.  Moreover, a replacement transaction may only be
accepted when it pays sufficient fee, as described in [BIP 125]
(https://github.com/bitnova/bips/blob/master/bip-0125.mediawiki).
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
Note that the wallet in BitNova Core 0.12 does not yet have support for
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
This allows running bitnovad without having to do any manual configuration.
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
BitNova Core has a heuristic 'priority' based on coin value and age. This
calculation is used for relaying of transactions which do not pay the
minimum relay fee, and can be used as an alternative way of sorting
transactions for mined blocks. BitNova Core will relay transactions with
insufficient fees depending on the setting of `-limitfreerelay=<r>` (default:
`r=15` kB per minute) and `-blockprioritysize=<s>`.

In BitNova Core 0.12, when mempool limit has been reached a higher minimum
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
entirely in BitNova Core 0.13, and it is at this time undecided whether the
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
BitNova Core has been updated to make use of this.

This means that if Tor is running (and proper authorization is available),
BitNova Core automatically creates a hidden service to listen on, without
manual configuration. BitNova Core will also use Tor automatically to connect
to other .onion nodes if the control socket can be successfully opened. This
will positively affect the number of available .onion nodes and their usage.

This new feature is enabled by default if BitNova Core is listening, and
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
BitNovad can now (optionally) asynchronously notify clients through a
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
(or `settxfee <n>` rpc during runtime). A value of `n=0` signals BitNova
Core to use floating fees. By default, BitNova Core will use floating
>>>>>>> 5360f2baff (Initialized BitNova project)
fees.
...
=======
At all times, BitNova Core will cap fees at `-maxtxfee=<x>` (default:
0.10) BTC.
Furthermore, BitNova Core will never create transactions paying less than
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
`bitnova.conf`, where `N` is the number of MiB to allot for
>>>>>>> 5360f2baff (Initialized BitNova project)
raw block & undo data.
...
=======
notes of v0.11.0](https://github.com/bitnova/bitnova/blob/v0.11.0/doc/release-notes.md#block-file-pruning).
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
111](https://github.com/bitnova/bips/blob/master/bip-0111.mediawiki), has been
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
* OP_NOP2 has been renamed to OP_CHECKLOCKTIMEVERIFY by [BIP 65](https://github.com/bitnova/bips/blob/master/bip-0065.mediawiki)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
        # optional bypass bitnovad rpc basic auth
        # RequestHeader set Authorization "Basic <hash>"
        # get the <hash> from the shell with: base64 <<< bitnovarpc:<password>
>>>>>>> 5360f2baff (Initialized BitNova project)
    </Location>
...
=======
Restarting bitnovad will no longer clear out the list of banned peers; instead
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #6214 `87406aa` [OSX] revert renaming of BitNova-Qt.app and use CFBundleDisplayName (partial revert of #6116) (Jonas Schnelli)
- #6218 `9d67b10` build/gitian misc updates (Cory Fields)
- #6269 `d4565b6` gitian: Use the new bitnova-detached-sigs git repo for OSX signatures (Cory Fields)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #6600 `ef4945f` Include bitnova-tx binary on Debian/Ubuntu (Zak Wilcox)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #6390 `6a73d66` tests: Fix bitnova-tx signing test case (Wladimir J. van der Laan)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #6730 `cb4d6d0` build: Remove dependency of bitnova-cli on secp256k1 (Wladimir J. van der Laan)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #6387 `11576a5` [bitnova-cli] improve error output (Jonas Schnelli)
- #6401 `6db53b4` Add BITCOIND_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
- #6430 `b01981e` doc: add documentation for shared library libbitnovaconsensus (Braydon Fuller)
>>>>>>> 5360f2baff (Initialized BitNova project)
