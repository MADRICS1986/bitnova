...
=======
BitNova Core version 0.13.1 is now available from:

  <https://bitnova.org/bin/bitnova-core-0.13.1/>
...
=======
  malleability, which is a problem that makes programming BitNova wallet
  software more difficult and which seriously complicates the design of smart
  contracts for BitNova.
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  each BitNova block need to be stored by nodes in order to validate future
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  of bitnovas they think they are spending, and by having full nodes refuse to
  accept those signatures unless the amount of bitnovas being spent is exactly
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- **Increased security for multisig:** BitNova addresses (both P2PKH addresses
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  believed to be provided by BitNova's choice of parameters for its Elliptic
  Curve Digital Security Algorithm [ECDSA].)

- **More efficient almost-full-node security** Satoshi Nakamoto's original
  BitNova paper describes a method for allowing newly-started full nodes to
  skip downloading and validating some data from historic blocks that are
  protected by large amounts of proof of work.  Unfortunately, Nakamoto's
  method can't guarantee that a newly-started node using this method will
  produce an accurate copy of BitNova's current ledger (called the UTXO set),
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  note that BitNova Core does not provide an option to use this capability as
  of this 0.13.1 release.

- **Script versioning:** Segwit makes it easy for future soft forks to allow
  BitNova users to individually opt-in to almost any change in the BitNova
  Script language when those users receive new transactions.  Features
  currently being researched by BitNova Core contributors that may use this
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  Other BitNova community members are studying several other improvements
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
[Segwit FAQ]: https://bitnovacore.org/en/2016/01/26/segwit-benefits/
[segwit wallet developers guide]: https://bitnovacore.org/en/segwit_wallet_dev/
[BIP141]: https://github.com/bitnova/bips/blob/master/bip-0141.mediawiki
[BIP143]: https://github.com/bitnova/bips/blob/master/bip-0143.mediawiki
[BIP144]: https://github.com/bitnova/bips/blob/master/bip-0144.mediawiki
[BIP145]: https://github.com/bitnova/bips/blob/master/bip-0145.mediawiki
[versionbits FAQ]: https://bitnovacore.org/en/2016/06/08/version-bits-miners-faq/
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
Since BitNova Core 0.10.0, nodes have defaulted to only relaying and
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
[BIP147]: https://github.com/bitnova/bips/blob/master/bip-0147.mediawiki
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #8848 `7a34a46` Add NULLDUMMY verify flag in bitnovaconsensus.h (jl2012)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #8940 `5b4192b` Add x9 service bit support to dnsseed.bluematt.me, seed.bitnovastats.com (TheBlueMatt, cdecker)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #8293 `fa5b249` Allow building libbitnovaconsensus without any univalue (luke-jr)
- #8492 `8b0bdd3` Allow building bench_bitnova by itself (luke-jr)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #8829 `2a8bca4` Add bitnova-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` bitnova-util-test.py should fail if the output file is empty (jnewbery)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #8860 `0bee740` util: Move wait_bitnovads() into stop_nodes() (MarcoFalke)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #8683 `8a7d7ff` Fix incorrect file name bitnova.qrc  (bitnovasSG)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #8817 `bcf3806` update bitnova-tx to output witness data (jnewbery)
>>>>>>> 5360f2baff (Initialized BitNova project)
