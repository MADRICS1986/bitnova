...
=======
BitNova Core version 0.21.0 is now available from:

  <https://bitnovacore.org/bin/bitnova-core-0.21.0/>
...
=======
  [BIP155](https://github.com/bitnova/bips/blob/master/bip-0155.mediawiki).
  Version 2 hidden services are still fully supported by BitNova Core, but the
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  `-datadir`) and can be removed if not needed. BitNova Core will no longer
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  [BIP157](https://github.com/bitnova/bips/blob/master/bip-0157.mediawiki) compact
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  ([BIP325](https://github.com/bitnova/bips/blob/master/bip-0325.mediawiki)) in
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  [BIP339](https://github.com/bitnova/bips/blob/master/bip-0339.mediawiki)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  ([BIP341](https://github.com/bitnova/bips/blob/master/bip-0341.mediawiki) and
  [BIP342](https://github.com/bitnova/bips/blob/master/bip-0342.mediawiki)),
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- A new `bitnova-cli -netinfo` command provides a network peer connections
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- A new `bitnova-cli -generate` command, equivalent to RPC `generatenewaddress`
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- The `bitnova-cli -getinfo` command now displays the wallet name and balance for
  each of the loaded wallets when more than one is loaded (e.g. in multiwallet
  mode) and a wallet is not specified with `-rpcwallet`. (#18594)

- The `connections` field of `bitnova-cli -getinfo` is now expanded to return a JSON
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  execute when BitNova Core has finished with its startup
>>>>>>> 5360f2baff (Initialized BitNova project)
  sequence. (#15367)
...
=======
  has been added to the `bitnova-wallet` tool which performs the salvage
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
BitNova Core will no longer automatically create new wallets on startup. It will
load existing wallets specified by `-wallet` options on the command line or in
`bitnova.conf` or `settings.json` files. And by default it will also load a
top-level unnamed ("") wallet. However, if specified wallets don't exist,
BitNova Core will now just log warnings instead of creating new wallets with
new keys and addresses like previous releases did.

New wallets can be created through the GUI (which has a more prominent create
wallet option), through the `bitnova-cli createwallet` or `bitnova-wallet
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
Bugs and missing functionality can be reported to the [issue tracker](https://github.com/bitnova/bitnova/issues).
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
Users who already have a BitNova Core wallet can continue to use it as they did before without
any change in behavior. Newly created Legacy Wallets (which remains the default type of wallet) will
behave as they did in previous versions of BitNova Core.
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
The change to using descriptors changes the default derivation paths used by BitNova Core
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  startup, so they don't need to be manually reloaded next time BitNova Core is
  started. The list of wallets to load on startup is stored in
  `\<datadir\>/settings.json` and augments any command line or `bitnova.conf`
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #19284 Add seed.bitnova.wiz.biz to DNS seeds (wiz)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #20198 Show name, format and if uses descriptors in bitnova-wallet tool (jonasschnelli)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #19133 rpc, cli, test: add bitnova-cli -generate command (jonatack)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #20055 Set HTTP Content-Type in bitnova-cli (laanwj)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #18504 Drop bitnova-tx and bitnova-wallet dependencies on libevent (ryanofsky)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #18653 add coverage for bitnova-cli -rpcwait (jonatack)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #18739 Document how to fuzz BitNova Core using Honggfuzz (practicalswift)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #19061 Add link to Visual Studio build readme (maitrebitnova)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #18817 Document differences in bitnovad and bitnova-qt locale handling (practicalswift)
>>>>>>> 5360f2baff (Initialized BitNova project)
