...
=======
BitNova Core version 0.19.0.1 is now available from:

  <https://bitnovacore.org/bin/bitnova-core-0.19.0.1/>
...
Users running macOS Catalina may need to "right-click" and then choose "Open"
to open the BitNova Core .dmg. This is due to new signing requirements
imposed by Apple, which the BitNova Core project does not yet adhere too.
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- [Reduce memory](https://github.com/bitnova/bitnova/blob/master/doc/reduce-memory.md)
  suggests configuration tweaks for running BitNova Core on systems with
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  currently use about 4 GiB of space.  Note: this version of BitNova
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  releases.  See the `bitnovad -help` output for these two options for
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- In 0.18.0, a `./configure` flag was introduced to allow disabling BIP70 support in the GUI (support was enabled by default). In 0.19.0, this flag is now __disabled__ by default. If you want to compile BitNova Core with BIP70 support in the GUI, you can pass `--enable-bip70` to `./configure`. (#15584)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- `generate` is now removed after being deprecated in BitNova Core 0.18.
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  future version of BitNova Core. (#14054)

- To eliminate well-known denial-of-service vectors in BitNova Core,
  especially for nodes with spinning disks, the default value for the
  `-peerbloomfilters` configuration option has been changed to false.
  This prevents BitNova Core from sending the BIP111 NODE_BLOOM service
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  of BitNova Core and nodes that have manually enabled BIP37 support,
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- By default, BitNova Core will now make two additional outbound connections that are exclusively used for block-relay.  No transactions or addr messages will be processed on these connections. These connections are designed to add little additional memory or bandwidth resource requirements but should make some partitioning attacks more difficult to carry out. (#15759)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- The `testnet` field in `bitnova-cli -getinfo` has been renamed to
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  an additional `type` field describes how BitNova Core determines
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  BitNova Core would sequentially attempt to download the transaction from each
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- If a Tor hidden service is being used, BitNova Core will be bound to
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  and services can accept any valid bech32 BitNova address without
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  partial spends" (added in BitNova Core v0.17.0), this can eliminate a
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #15649 Add ChaCha20Poly1305@BitNova AEAD (jonasschnelli)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #15639 bitnova-wallet tool: Drop libbitnova_server.a dependency (ryanofsky)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #16366 init: Use InitError for all errors in bitnovad/qt (MarcoFalke)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #15239 scripts and tools: Move non-linux build source tarballs to "bitnova-binaries/version" directory (hebasto)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #16258 [MSVC]: Create the config.ini as part of bitnovad build (NicolasDorier)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #16441 remove qt libjpeg check from bitnova_qt.m4 (fanquake)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #16750 msbuild: adds bench_bitnova to auto generated project files (sipsorcery)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #15773 Add BitNovaTestFramework::sync_* methods (MarcoFalke)
- #15797 travis: Bump second timeout to 33 minutes, add rationale (MarcoFalke)
- #15788 Unify testing setups for fuzz, bench, and unit tests (MarcoFalke)
- #15352 Reduce noise level in test_bitnova output (practicalswift)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #15896 feature_filelock, interface_bitnova_cli: Use PACKAGE_NAME in messages rather than hardcoding BitNova Core (luke-jr)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #16277 Suppress output in test_bitnova for expected errors (gertjaap)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #16489 log: harmonize bitnovad logging (jonatack)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #17449 fix uninitialized variable nMinerConfirmationWindow (bitnovaVBR)

### Documentation
- #15514 Update Transifex links (fanquake)
- #15513 add "sections" info to example bitnova.conf (fanquake)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #16080 build/doc: update bitnova_config.h packages, release process (jonatack)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #16448 add note on precedence of options in bitnova.conf (fanquake)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #16621 add default bitnova.conf locations (GChuf)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #16863 Add a missing closing parenthesis in the bitnova-wallet's help (darosior)
- #16757 CChainState return values (MarcoFalke)
- #16847 add comments clarifying how local services are advertised (jamesob)
- #16812 Fix whitespace errs in .md files, bitnova.conf, and Info.plist.in (ch4ot1c)
- #16885 Update tx-size-small comment with relevant CVE disclosure (instagibbs)
- #16900 Fix doxygen comment for SignTransaction in rpc/rawtransaction_util (MarcoFalke)
- #16914 Update homebrew instruction for doxygen (Sjors)
- #16912 Remove Doxygen intro from src/bitnovad.cpp (ch4ot1c)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
As well as everyone that helped translating on [Transifex](https://www.transifex.com/bitnova/bitnova/).
>>>>>>> 5360f2baff (Initialized BitNova project)
