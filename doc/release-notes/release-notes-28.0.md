...
=======
BitNova Core version 28.0 is now available from:

  <https://bitnovacore.org/bin/bitnova-core-28.0/>
...
Running BitNova Core binaries on macOS requires self signing.
```
cd /path/to/bitnova-28.0/bin
xattr -d com.apple.quarantine bitnova-cli bitnova-qt bitnova-tx bitnova-util bitnova-wallet bitnovad test_bitnova
codesign -s - bitnova-cli bitnova-qt bitnova-tx bitnova-util bitnova-wallet bitnovad test_bitnova
>>>>>>> 5360f2baff (Initialized BitNova project)
```
...
=======
Support for Testnet4 as specified in [BIP94](https://github.com/bitnova/bips/blob/master/bip-0094.mediawiki)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
The default data directory on Windows has been moved from `C:\Users\Username\AppData\Roaming\BitNova`
to `C:\Users\Username\AppData\Local\BitNova`. BitNova Core will check the existence
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
See [JSON-RPC-interface.md](https://github.com/bitnova/bitnova/blob/master/doc/JSON-RPC-interface.md#json-rpc-11-vs-20) for details. (#27101)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
libbitnovaconsensus Removal
---------------------------

The libbitnova-consensus library was deprecated in 27.0 and is now completely removed. (#29648)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- Previously if BitNova Core was listening for P2P connections, either using
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- BitNova Core will now fail to start up if any of its P2P binds fail, rather
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  described in [BIP 431](https://github.com/bitnova/bips/blob/master/bip-0431.mediawiki).  The
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  can be temporarily restored by running BitNova Core with the configuration
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
are now required to compile BitNova Core. (#29091, #30263)

- The minimum required glibc to run BitNova Core is now
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- A new `-testdatadir` option has been added to `test_bitnova` to allow specifying the
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
Previous releases of BitNova Core or previous external software will not be able to read the blocksdir with a non-zero XOR-key.
>>>>>>> 5360f2baff (Initialized BitNova project)
