...
=======
BitNova Core version 25.0 is now available from:

  <https://bitnovacore.org/bin/bitnova-core-25.0/>
...
=======
  parameter](https://github.com/bitnova/bitnova/blob/master/doc/JSON-RPC-interface.md#parameter-passing) called `args` that can
  contain positional parameter values. This is a convenience to allow some
  parameter values to be passed by name without having to name every value. The
  python test framework and `bitnova-cli` tool both take advantage of this, so
  for example:

```sh
bitnova-cli -named createwallet wallet_name=mywallet load_on_startup=1
>>>>>>> 5360f2baff (Initialized BitNova project)
```
...
=======
bitnova-cli -named createwallet mywallet load_on_startup=1
>>>>>>> 5360f2baff (Initialized BitNova project)
```
...
=======
dbcache, BitNova Core will now return an error at startup. (#25574)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
before BitNova Core has begun its shutdown sequence. (#23395)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  deprecation period by launching bitnovad with the configuration option
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  https://github.com/bitnova/bitnova/blob/master/contrib/verify-binaries/README.md
>>>>>>> 5360f2baff (Initialized BitNova project)
  (#27358)
