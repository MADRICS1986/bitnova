...
=======
BitNova Core version 0.13.2 is now available from:

  <https://bitnova.org/bin/bitnova-core-0.13.2/>
...
=======
- #8908 `4a974b2` Update bitnova-qt.desktop (s-matthew-english)
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- #8932 `106da69` Allow bitnova-tx to create v2 transactions (btcdrak)
>>>>>>> 5360f2baff (Initialized BitNova project)
