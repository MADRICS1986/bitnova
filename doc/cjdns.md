...
=======
# CJDNS support in BitNova Core

It is possible to run BitNova Core over CJDNS, an encrypted IPv6 network that
...
=======
done outside of BitNova Core, similarly to a VPN (either in the host/OS or on
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
redundancy and robustness for both the BitNova network and individual nodes.
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
before it will work with your BitNova Core node. This is described in steps
>>>>>>> 5360f2baff (Initialized BitNova project)
