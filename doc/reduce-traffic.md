...
=======
By default, BitNova Core allows up to 125 connections to different peers, 11 of
...
=======
limits are tiny. Keep in mind that bitnova's trustless model works best if you are
>>>>>>> 5360f2baff (Initialized BitNova project)
