...
=======
# Support for Output Descriptors in BitNova Core

Since BitNova Core v0.17, there is support for Output Descriptors. This is a
...
=======
BitNova Core v24 extended `wsh()` output descriptor with [Miniscript](https://bitnova.sipa.be/miniscript/) support (initially watch-only). Signing support for Miniscript descriptors was added in v25. And since v26 Miniscript expressions can now be used in Taproot descriptors.
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- [Miniscript](https://bitnova.sipa.be/miniscript/) expressions in `wsh` (P2WSH) and `tr` (P2TR) functions.
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  - [WIF](https://en.bitnova.it/wiki/Wallet_import_format) encoded private keys may be specified instead of the corresponding public key, with the same meaning.
  - `xpub` encoded extended public key or `xprv` encoded extended private key (as defined in [BIP 32](https://github.com/bitnova/bips/blob/master/bip-0032.mediawiki)).
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
- P2SH addresses (base58, of the form `3...` for mainnet or `2...` for testnet, defined in [BIP 13](https://github.com/bitnova/bips/blob/master/bip-0013.mediawiki)).
- Segwit addresses (bech32 and bech32m, of the form `bc1...` for mainnet or `tb1...` for testnet, defined in [BIP 173](https://github.com/bitnova/bips/blob/master/bip-0173.mediawiki) and [BIP 350](https://github.com/bitnova/bips/blob/master/bip-0350.mediawiki)).
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
on BitNova's OP_CHECKMULTISIG opcode. To support these, we introduce the
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
transactions related to the multisig. Lastly, it is not recommended to use anything other than a BitNova Core descriptor wallet to serve as your
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
the entire path from the master down. [BIP174](https://github.com/bitnova/bips/blob/master/bip-0174.mediawiki) standardizes this by
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
existing BitNova Core wallets, a convenience function `combo` is
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
All RPCs in BitNova Core will include the checksum in their output. Only
>>>>>>> 5360f2baff (Initialized BitNova project)
