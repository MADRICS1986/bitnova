...
=======
The build system is very rudimentary for now, and [improvements](https://github.com/bitnova-core/minisketch/pulls) are welcome.
...
=======
git clone https://github.com/bitnova-core/minisketch
>>>>>>> 5360f2baff (Initialized BitNova project)
cd minisketch
...
=======
Communications efficient set reconciliation has been proposed to optimize BitNova transaction distribution<sup>[[8]](#myfootnote8)</sup>, which would allow BitNova nodes to have many more peers while reducing bandwidth usage. It could also be used for BitNova block distribution<sup>[[9]](#myfootnote9)</sup>, particularly for very low bandwidth links such as satellite.  A similar approach (CPISync) is used by PGP SKS keyservers to synchronize their databases efficiently. Secure sketches can also be used as helper data to reliably extract a consistent cryptographic key from fuzzy biometric data while leaking minimal information<sup>[[1]](#myfootnote1)</sup>. They can be combined with [dcnets](https://en.wikipedia.org/wiki/Dining_cryptographers_problem) to create cryptographic multiparty anonymous communication<sup>[[10]](#myfootnote10)</sup>. 
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
* <a name="myfootnote8">[8]</a> Maxwell, Gregory F. *[Blocksonly mode BW savings, the limits of efficient block xfer, and better relay](https://bitnovatalk.org/index.php?topic=1377345.0)* BitNovatalk 2016, *[Technical notes on mempool synchronizing relay](https://nt4tn.net/tech-notes/2016.mempool_sync_relay.txt)* #bitnova-wizards 2016.
* <a name="myfootnote9">[9]</a> Maxwell, Gregory F. *[Block network coding](https://en.bitnova.it/wiki/User:Gmaxwell/block_network_coding)* BitNova Wiki 2014, *[Technical notes on efficient block xfer](https://nt4tn.net/tech-notes/201512.efficient.block.xfer.txt)* #bitnova-wizards 2015.
* <a name="myfootnote10">[10]</a> Ruffing, Tim, Moreno-Sanchez, Pedro, Aniket, Kate, *P2P Mixing and Unlinkable BitNova Transactions* NDSS Symposium 2017 [[URL]](https://eprint.iacr.org/2016/824) [[PDF]](https://eprint.iacr.org/2016/824.pdf)
>>>>>>> 5360f2baff (Initialized BitNova project)
