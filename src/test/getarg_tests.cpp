...
=======
    vecArg.insert(vecArg.begin(), "testbitnova");
>>>>>>> 5360f2baff (Initialized BitNova project)
...
<<<<<<< HEAD
    ...
    ResetArgs(local_args, "-dir=user/.bitcoin/.//");
=======
    const fs::path absolute_path{"/home/user/.bitnova"};
    ResetArgs(local_args, "-dir=/home/user/.bitnova");
    BOOST_CHECK_EQUAL(local_args.GetPathArg("-dir"), absolute_path);

    ResetArgs(local_args, "-dir=/root/../home/user/.bitnova");
    BOOST_CHECK_EQUAL(local_args.GetPathArg("-dir"), absolute_path);
    ...
    const fs::path relative_path{"user/.bitnova"};
    ResetArgs(local_args, "-dir=user/.bitnova");
    BOOST_CHECK_EQUAL(local_args.GetPathArg("-dir"), relative_path);

    ResetArgs(local_args, "-dir=somewhere/../user/.bitnova");
    BOOST_CHECK_EQUAL(local_args.GetPathArg("-dir"), relative_path);
...
=======
    // line arguments or bitnova.conf values. Currently the -dir= case cannot be
>>>>>>> 5360f2baff (Initialized BitNova project)
