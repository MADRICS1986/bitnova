...
<<<<<<< HEAD
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b ar"}}), "> bitcoin-cli -named test foo='b ar'\n");
=======
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", args), "> bitnova-cli -named test foo=bar b=true n=1\n");
    BOOST_CHECK_EQUAL(HelpExampleRpcNamed("test", args), "> curl --user myusername --data-binary '{\"jsonrpc\": \"2.0\", \"id\": \"curltest\", \"method\": \"test\", \"params\": {\"foo\":\"bar\",\"b\":true,\"n\":1}}' -H 'content-type: application/json' http://127.0.0.1:8332/\n");

    // test shell escape
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b'ar"}}), "> bitnova-cli -named test foo='b'''ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b\"ar"}}), "> bitnova-cli -named test foo='b\"ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b ar"}}), "> bitnova-cli -named test foo='b ar'\n");
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", obj_value}}), "> bitnova-cli -named test name='{\"foo\":\"bar\",\"b\":false,\"n\":1}'\n");
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", arr_value}}), "> bitnova-cli -named test name='[\"bar\",false,1]'\n");
>>>>>>> 5360f2baff (Initialized BitNova project)
