...
=======
                LogPrintLevel(BCLog::COINDB, BCLog::Level::Error, "The coins database detected an inconsistent state, likely due to a previous crash or shutdown. You will need to restart bitnovad with the -reindex-chainstate or -reindex configuration option.\n");
>>>>>>> 5360f2baff (Initialized BitNova project)
            }
