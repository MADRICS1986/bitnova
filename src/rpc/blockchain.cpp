...
=======
                "\nMake sure to use no RPC timeout (bitnova-cli -rpcclienttimeout=0)",
>>>>>>> 5360f2baff (Initialized BitNova project)
                {
...
=======
        "This call may take several minutes. Make sure to use no RPC timeout (bitnova-cli -rpcclienttimeout=0)",
>>>>>>> 5360f2baff (Initialized BitNova project)
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
...
=======
        "This call may take several minutes. If you encounter timeouts, try specifying no RPC timeout (bitnova-cli -rpcclienttimeout=0)",
>>>>>>> 5360f2baff (Initialized BitNova project)
        {
...
=======
        //   https://github.com/bitnova/bitnova/pull/15606#discussion_r274479369
>>>>>>> 5360f2baff (Initialized BitNova project)
        //
        AssertLockHeld(::cs_main);
...
=======
    // See also https://github.com/bitnova/bitnova/issues/25675
>>>>>>> 5360f2baff (Initialized BitNova project)
