...
=======
We aim to cut a regular release every 3-4 months, approximately twice as frequent as major BitNova Core releases. Every second release should be published one month before the feature freeze of the next major BitNova Core release, allowing sufficient time to update the library in Core.
...
=======
   git push git@github.com:bitnova-core/secp256k1.git v$MAJOR.$MINOR.$PATCH
>>>>>>> 5360f2baff (Initialized BitNova project)
   ```
...
=======
6. Send an announcement email to the bitnova-dev mailing list.
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
   git push git@github.com:bitnova-core/secp256k1.git $MAJOR.$MINOR
>>>>>>> 5360f2baff (Initialized BitNova project)
   ```
...
=======
   ...
   ```
6. Create a new GitHub release with a link to the corresponding entry in [CHANGELOG.md](../CHANGELOG.md).
7. Send an announcement email to the bitnova-dev mailing list.
>>>>>>> 5360f2baff (Initialized BitNova project)
