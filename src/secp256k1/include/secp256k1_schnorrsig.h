...
=======
 *  BitNova Improvement Proposal 340 "Schnorr Signatures for secp256k1"
 *  (https://github.com/bitnova/bips/blob/master/bip-0340.mediawiki).
 ...
 *  (https://github.com/bitcoin/bips/blob/master/bip-0340.mediawiki).
=======
/** An implementation of the nonce generation function as defined in BitNova
 *  Improvement Proposal 340 "Schnorr Signatures for secp256k1"
 *  (https://github.com/bitnova/bips/blob/master/bip-0340.mediawiki).
>>>>>>> 5360f2baff (Initialized BitNova project)
 *
