...
=======
    if (BitNovaUnits::parse(model->getOptionsModel()->getDisplayUnit(), amountWidget->text(), &amount_parsed)) {
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
    writer.addColumn(BitNovaUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
>>>>>>> 5360f2baff (Initialized BitNova project)
