...
=======
const std::string BitNovaGUI::DEFAULT_UIPLATFORM =
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
BitNovaGUI::BitNovaGUI(interfaces::Node& node, const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
>>>>>>> 5360f2baff (Initialized BitNova project)
    QMainWindow(parent),
    m_node(node),
...
=======
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &BitNovaGUI::createWallet);
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
    connect(labelBlocksIcon, &GUIUtil::ClickableLabel::clicked, this, &BitNovaGUI::showModalOverlay);
    connect(progressBar, &GUIUtil::ClickableProgressBar::clicked, this, &BitNovaGUI::showModalOverlay);
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
    sendCoinsAction->setStatusTip(tr("Send coins to a BitNova address"));
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitnova: URIs)"));
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
    connect(overviewAction, &QAction::triggered, this, &BitNovaGUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsAction, &QAction::triggered, this, &BitNovaGUI::gotoReceiveCoinsPage);
    connect(historyAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(historyAction, &QAction::triggered, this, &BitNovaGUI::gotoHistoryPage);
>>>>>>> 5360f2baff (Initialized BitNova project)
#endif // ENABLE_WALLET
...
=======
    signMessageAction->setStatusTip(tr("Sign messages with your BitNova addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message…"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitNova addresses"));
    m_load_psbt_action = new QAction(tr("&Load PSBT from file…"), this);
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed BitNova Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed BitNova Transaction from clipboard"));
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
    openAction->setStatusTip(tr("Open a bitnova: URI"));
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible BitNova command-line options").arg(CLIENT_NAME));
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
    connect(quitAction, &QAction::triggered, this, &BitNovaGUI::quitRequested);
    connect(aboutAction, &QAction::triggered, this, &BitNovaGUI::aboutClicked);
    connect(aboutQtAction, &QAction::triggered, qApp, QApplication::aboutQt);
    connect(optionsAction, &QAction::triggered, this, &BitNovaGUI::optionsClicked);
    connect(showHelpMessageAction, &QAction::triggered, this, &BitNovaGUI::showHelpMessageClicked);
    connect(openRPCConsoleAction, &QAction::triggered, this, &BitNovaGUI::showDebugWindow);
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
        connect(openAction, &QAction::triggered, this, &BitNovaGUI::openClicked);
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
                    connect(activity, &OpenWalletActivity::opened, this, &BitNovaGUI::setCurrentWallet, Qt::QueuedConnection);
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
            connect(activity, &RestoreWalletActivity::restored, this, &BitNovaGUI::setCurrentWallet, Qt::QueuedConnection);
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
        connect(m_create_wallet_action, &QAction::triggered, this, &BitNovaGUI::createWallet);
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
                    connect(activity, &MigrateWalletActivity::migrated, this, &BitNovaGUI::setCurrentWallet);
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
        connect(m_mask_values_action, &QAction::toggled, this, &BitNovaGUI::setPrivacy);
        connect(m_mask_values_action, &QAction::toggled, this, &BitNovaGUI::enableHistoryAction);
    }
#endif // ENABLE_WALLET

    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_C), this), &QShortcut::activated, this, &BitNovaGUI::showDebugWindowActivateConsole);
    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_D), this), &QShortcut::activated, this, &BitNovaGUI::showDebugWindow);
}

void BitNovaGUI::createMenuBar()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
    appMenuBar = menuBar();
...
=======
void BitNovaGUI::createToolBars()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
    if(walletFrame)
    {
...
=======
        connect(m_wallet_selector, qOverload<int>(&QComboBox::currentIndexChanged), this, &BitNovaGUI::setCurrentWalletBySelectorIndex);
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
void BitNovaGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
        connect(_clientModel, &ClientModel::numConnectionsChanged, this, &BitNovaGUI::setNumConnections);
        connect(_clientModel, &ClientModel::networkActiveChanged, this, &BitNovaGUI::setNetworkActive);

        modalOverlay->setKnownBestHeight(tip_info->header_height, QDateTime::fromSecsSinceEpoch(tip_info->header_time), /*presync=*/false);
        setNumBlocks(tip_info->block_height, QDateTime::fromSecsSinceEpoch(tip_info->block_time), tip_info->verification_progress, SyncType::BLOCK_SYNC, SynchronizationState::INIT_DOWNLOAD);
        connect(_clientModel, &ClientModel::numBlocksChanged, this, &BitNovaGUI::setNumBlocks);
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
        connect(_clientModel, &ClientModel::showProgress, this, &BitNovaGUI::showProgress);
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
void BitNovaGUI::enableHistoryAction(bool privacy)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
    GUIUtil::ExceptionSafeConnect(wallet_controller, &WalletController::walletAdded, this, &BitNovaGUI::addWallet);
    connect(wallet_controller, &WalletController::walletRemoved, this, &BitNovaGUI::removeWallet);
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
WalletController* BitNovaGUI::getWalletController()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::addWallet(WalletModel* walletModel)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
    connect(wallet_view, &WalletView::outOfSyncWarningClicked, this, &BitNovaGUI::showModalOverlay);
    connect(wallet_view, &WalletView::transactionClicked, this, &BitNovaGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::coinsSent, this, &BitNovaGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        this->message(title, message, style);
    });
    connect(wallet_view, &WalletView::encryptionStatusChanged, this, &BitNovaGUI::updateWalletStatus);
    connect(wallet_view, &WalletView::incomingTransaction, this, &BitNovaGUI::incomingTransaction);
    connect(this, &BitNovaGUI::setPrivacy, wallet_view, &WalletView::setPrivacy);
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
void BitNovaGUI::removeWallet(WalletModel* walletModel)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::setCurrentWallet(WalletModel* wallet_model)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
    if (!walletFrame || !m_wallet_controller) return;
...
=======
void BitNovaGUI::setCurrentWalletBySelectorIndex(int index)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::removeAllWallets()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
    if(!walletFrame)
        return;
...
=======
void BitNovaGUI::setWalletActionsEnabled(bool enabled)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::createTrayIcon()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::createTrayIconMenu()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
#ifndef Q_OS_MACOS
    if (!trayIcon) return;
...
=======
    show_hide_action = trayIconMenu->addAction(QString(), this, &BitNovaGUI::toggleHidden);
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
void BitNovaGUI::optionsClicked()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::showDebugWindow()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::showDebugWindowActivateConsole()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::showHelpMessageClicked()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::gotoOverviewPage()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
    overviewAction->setChecked(true);
...
=======
void BitNovaGUI::gotoHistoryPage()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::gotoReceiveCoinsPage()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::gotoSendCoinsPage(QString addr)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::gotoSignMessageTab(QString addr)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::gotoVerifyMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoVerifyMessageTab(addr);
}
void BitNovaGUI::gotoLoadPSBT(bool from_clipboard)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::updateNetworkState()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
        tooltip = tr("%n active connection(s) to BitNova network.", "", count);
>>>>>>> 5360f2baff (Initialized BitNova project)
    } else {
        //: A substring of the tooltip.
...
=======
void BitNovaGUI::setNumConnections(int count)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
    updateNetworkState();
}
...
=======
void BitNovaGUI::setNetworkActive(bool network_active)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
    updateNetworkState();
...
=======
void BitNovaGUI::updateHeadersSyncProgressLabel()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
    connect(dlg, &OptionsDialog::quitOnReset, this, &BitNovaGUI::quitRequested);
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
void BitNovaGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
    connect(activity, &CreateWalletActivity::created, this, &BitNovaGUI::setCurrentWallet);
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
void BitNovaGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::changeEvent(QEvent *e)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
                QTimer::singleShot(0, this, &BitNovaGUI::hide);
>>>>>>> 5360f2baff (Initialized BitNova project)
                e->ignore();
            }
...
=======
                QTimer::singleShot(0, this, &BitNovaGUI::show);
>>>>>>> 5360f2baff (Initialized BitNova project)
                e->ignore();
            }
        }
...
=======
void BitNovaGUI::closeEvent(QCloseEvent *event)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
#ifndef Q_OS_MACOS // Ignored on Mac
    if(clientModel && clientModel->getOptionsModel())
...
=======
void BitNovaGUI::showEvent(QShowEvent *event)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::incomingTransaction(const QString& date, BitNovaUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
    // On new transaction, make an info balloon
    QString msg = tr("Date: %1\n").arg(date) +
                  tr("Amount: %1\n").arg(BitNovaUnits::formatWithUnit(unit, amount, true));
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
void BitNovaGUI::dragEnterEvent(QDragEnterEvent *event)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
    // Accept only URIs
...
=======
void BitNovaGUI::dropEvent(QDropEvent *event)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
    if(event->mimeData()->hasUrls())
    {
...
=======
bool BitNovaGUI::eventFilter(QObject *object, QEvent *event)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
bool BitNovaGUI::handlePaymentRequest(const SendCoinsRecipient& recipient)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
    // URI has to be valid
...
=======
void BitNovaGUI::setHDStatus(bool privkeyDisabled, int hdEnabled)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::setEncryptionStatus(int status)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
    switch(status)
    {
...
=======
void BitNovaGUI::updateWalletStatus()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
    assert(walletFrame);
...
=======
void BitNovaGUI::updateProxyIcon()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
    std::string ip_port;
...
=======
void BitNovaGUI::updateWindowTitle()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::showNormalIfMinimized(bool fToggleHidden)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
    if(!clientModel)
        return;
...
=======
void BitNovaGUI::detectShutdown()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::showProgress(const QString &title, int nProgress)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
    if (nProgress == 0) {
...
=======
void BitNovaGUI::showModalOverlay()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
static bool ThreadSafeMessageBox(BitNovaGUI* gui, const bilingual_str& message, const std::string& caption, unsigned int style)
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
        detailed_message = BitNovaGUI::tr("Original message:") + "\n" + QString::fromStdString(message.original);
>>>>>>> 5360f2baff (Initialized BitNova project)
    }
...
=======
void BitNovaGUI::subscribeToCoreSignals()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
void BitNovaGUI::unsubscribeFromCoreSignals()
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
bool BitNovaGUI::isPrivacyModeActivated() const
>>>>>>> 5360f2baff (Initialized BitNova project)
{
...
=======
    QList<BitNovaUnit> units = BitNovaUnits::availableUnits();
    int max_width = 0;
    const QFontMetrics fm(font());
    for (const BitNovaUnit unit : units) {
        max_width = qMax(max_width, GUIUtil::TextWidth(fm, BitNovaUnits::longName(unit)));
>>>>>>> 5360f2baff (Initialized BitNova project)
    }
...
=======
    for (const BitNovaUnit u : BitNovaUnits::availableUnits()) {
        menu->addAction(BitNovaUnits::longName(u))->setData(QVariant::fromValue(u));
>>>>>>> 5360f2baff (Initialized BitNova project)
    }
...
=======
void UnitDisplayStatusBarControl::updateDisplayUnit(BitNovaUnit newUnits)
{
    setText(BitNovaUnits::longName(newUnits));
>>>>>>> 5360f2baff (Initialized BitNova project)
}
