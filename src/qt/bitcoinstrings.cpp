...
QT_TRANSLATE_NOOP("bitcoin-core", ""
=======
static const char UNUSED *bitnova_strings[] = {
QT_TRANSLATE_NOOP("bitnova-core", "The %s developers"),
QT_TRANSLATE_NOOP("bitnova-core", ""
"%s corrupt. Try using the wallet tool bitnova-wallet to salvage or restoring "
"a backup."),
QT_TRANSLATE_NOOP("bitnova-core", ""
...
"Error: Dumpfile identifier record is incorrect. Got \"%s\", expected \"%s\"."),
QT_TRANSLATE_NOOP("bitnova-core", ""
"Error: Dumpfile version is not supported. This version of bitnova-wallet "
"only supports version 1 dumpfiles. Got dumpfile with version %s"),
QT_TRANSLATE_NOOP("bitnova-core", ""
"Error: Duplicate descriptors created during migration. Your wallet may be "
"corrupted."),
...
QT_TRANSLATE_NOOP("bitnova-core", ""
"whitebind may only be used for incoming connections (\"out\" was passed)"),
QT_TRANSLATE_NOOP("bitnova-core", "%s is set very high!"),
QT_TRANSLATE_NOOP("bitnova-core", "-maxmempool must be at least %d MB"),
QT_TRANSLATE_NOOP("bitnova-core", "A fatal internal error occurred, see debug.log for details: "),
QT_TRANSLATE_NOOP("bitnova-core", "Assumeutxo data not found for the given blockhash '%s'."),
QT_TRANSLATE_NOOP("bitnova-core", "Block verification was interrupted"),
QT_TRANSLATE_NOOP("bitnova-core", "Cannot obtain a lock on directory %s. %s is probably already running."),
QT_TRANSLATE_NOOP("bitnova-core", "Cannot resolve -%s address: '%s'"),
QT_TRANSLATE_NOOP("bitnova-core", "Cannot set -forcednsseed to true when setting -dnsseed to false."),
QT_TRANSLATE_NOOP("bitnova-core", "Cannot set -peerblockfilters without -blockfilterindex."),
QT_TRANSLATE_NOOP("bitnova-core", "Cannot write to directory '%s'; check permissions."),
QT_TRANSLATE_NOOP("bitnova-core", "Config setting for %s only applied on %s network when in [%s] section."),
QT_TRANSLATE_NOOP("bitnova-core", "Copyright (C) %i-%i"),
QT_TRANSLATE_NOOP("bitnova-core", "Corrupt block found indicating potential hardware failure."),
QT_TRANSLATE_NOOP("bitnova-core", "Corrupted block database detected"),
QT_TRANSLATE_NOOP("bitnova-core", "Could not find asmap file %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Could not parse asmap file %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Disk space is too low!"),
QT_TRANSLATE_NOOP("bitnova-core", "Do you want to rebuild the databases now?"),
QT_TRANSLATE_NOOP("bitnova-core", "Done loading"),
QT_TRANSLATE_NOOP("bitnova-core", "Dump file %s does not exist."),
QT_TRANSLATE_NOOP("bitnova-core", "Elliptic curve cryptography sanity check failure. %s is shutting down."),
QT_TRANSLATE_NOOP("bitnova-core", "Error creating %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Error initializing block database"),
QT_TRANSLATE_NOOP("bitnova-core", "Error initializing wallet database environment %s!"),
QT_TRANSLATE_NOOP("bitnova-core", "Error loading %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Error loading %s: Private keys can only be disabled during creation"),
QT_TRANSLATE_NOOP("bitnova-core", "Error loading %s: Wallet corrupted"),
QT_TRANSLATE_NOOP("bitnova-core", "Error loading %s: Wallet requires newer version of %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Error loading block database"),
QT_TRANSLATE_NOOP("bitnova-core", "Error loading databases"),
QT_TRANSLATE_NOOP("bitnova-core", "Error opening block database"),
QT_TRANSLATE_NOOP("bitnova-core", "Error opening coins database"),
QT_TRANSLATE_NOOP("bitnova-core", "Error reading configuration file: %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Error reading from database, shutting down."),
QT_TRANSLATE_NOOP("bitnova-core", "Error reading next record from wallet database"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Cannot extract destination from the generated scriptpubkey"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Could not add watchonly tx %s to watchonly wallet"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Could not delete watchonly transactions. "),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Couldn't create cursor into database"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Disk space is low for %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Dumpfile checksum does not match. Computed %s, expected %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Failed to create new watchonly wallet"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Got key that was not hex: %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Got value that was not hex: %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Keypool ran out, please call keypoolrefill first"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Missing checksum"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: No %s addresses available."),
QT_TRANSLATE_NOOP("bitnova-core", "Error: This wallet already uses SQLite"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: This wallet is already a descriptor wallet"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Unable to begin reading all records in the database"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Unable to make a backup of your wallet"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Unable to parse version %u as a uint32_t"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Unable to read all records in the database"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Unable to read wallet's best block locator record"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Unable to remove watchonly address book data"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Unable to write data to disk for wallet %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Unable to write record to new wallet"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Unable to write solvable wallet best block locator record"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Unable to write watchonly wallet best block locator record"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: Wallet does not exist"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: cannot remove legacy wallet records"),
QT_TRANSLATE_NOOP("bitnova-core", "Error: database transaction cannot be executed for wallet %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Failed to connect best block (%s)."),
QT_TRANSLATE_NOOP("bitnova-core", "Failed to disconnect block."),
QT_TRANSLATE_NOOP("bitnova-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("bitnova-core", "Failed to read block."),
QT_TRANSLATE_NOOP("bitnova-core", "Failed to rescan the wallet during initialization"),
QT_TRANSLATE_NOOP("bitnova-core", "Failed to start indexes, shutting down.."),
QT_TRANSLATE_NOOP("bitnova-core", "Failed to verify database"),
QT_TRANSLATE_NOOP("bitnova-core", "Failed to write block."),
QT_TRANSLATE_NOOP("bitnova-core", "Failed to write to block index database."),
QT_TRANSLATE_NOOP("bitnova-core", "Failed to write to coin database."),
QT_TRANSLATE_NOOP("bitnova-core", "Failed to write undo data."),
QT_TRANSLATE_NOOP("bitnova-core", "Failure removing transaction: %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Fee rate (%s) is lower than the minimum fee rate setting (%s)"),
QT_TRANSLATE_NOOP("bitnova-core", "Ignoring duplicate -wallet %s."),
QT_TRANSLATE_NOOP("bitnova-core", "Importing…"),
QT_TRANSLATE_NOOP("bitnova-core", "Incorrect or no genesis block found. Wrong datadir for network?"),
QT_TRANSLATE_NOOP("bitnova-core", "Initialization sanity check failed. %s is shutting down."),
QT_TRANSLATE_NOOP("bitnova-core", "Input not found or already spent"),
QT_TRANSLATE_NOOP("bitnova-core", "Insufficient dbcache for block verification"),
QT_TRANSLATE_NOOP("bitnova-core", "Insufficient funds"),
QT_TRANSLATE_NOOP("bitnova-core", "Invalid -i2psam address or hostname: '%s'"),
QT_TRANSLATE_NOOP("bitnova-core", "Invalid -onion address or hostname: '%s'"),
QT_TRANSLATE_NOOP("bitnova-core", "Invalid -proxy address or hostname: '%s'"),
QT_TRANSLATE_NOOP("bitnova-core", "Invalid P2P permission: '%s'"),
QT_TRANSLATE_NOOP("bitnova-core", "Invalid amount for %s=<amount>: '%s' (must be at least %s)"),
QT_TRANSLATE_NOOP("bitnova-core", "Invalid amount for %s=<amount>: '%s'"),
QT_TRANSLATE_NOOP("bitnova-core", "Invalid amount for -%s=<amount>: '%s'"),
QT_TRANSLATE_NOOP("bitnova-core", "Invalid netmask specified in -whitelist: '%s'"),
QT_TRANSLATE_NOOP("bitnova-core", "Invalid port specified in %s: '%s'"),
QT_TRANSLATE_NOOP("bitnova-core", "Invalid pre-selected input %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Listening for incoming connections failed (listen returned error %s)"),
QT_TRANSLATE_NOOP("bitnova-core", "Loading P2P addresses…"),
QT_TRANSLATE_NOOP("bitnova-core", "Loading banlist…"),
QT_TRANSLATE_NOOP("bitnova-core", "Loading block index…"),
QT_TRANSLATE_NOOP("bitnova-core", "Loading wallet…"),
QT_TRANSLATE_NOOP("bitnova-core", "Maximum transaction weight must be between %d and %d"),
QT_TRANSLATE_NOOP("bitnova-core", "Missing amount"),
QT_TRANSLATE_NOOP("bitnova-core", "Missing solving data for estimating transaction size"),
QT_TRANSLATE_NOOP("bitnova-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("bitnova-core", "No addresses available"),
QT_TRANSLATE_NOOP("bitnova-core", "Not enough file descriptors available. %d available, %d required."),
QT_TRANSLATE_NOOP("bitnova-core", "Not found pre-selected input %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Not solvable pre-selected input %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Only direction was set, no permissions: '%s'"),
QT_TRANSLATE_NOOP("bitnova-core", "Prune cannot be configured with a negative value."),
QT_TRANSLATE_NOOP("bitnova-core", "Prune mode is incompatible with -txindex."),
QT_TRANSLATE_NOOP("bitnova-core", "Pruning blockstore…"),
QT_TRANSLATE_NOOP("bitnova-core", "Reducing -maxconnections from %d to %d, because of system limitations."),
QT_TRANSLATE_NOOP("bitnova-core", "Replaying blocks…"),
QT_TRANSLATE_NOOP("bitnova-core", "Rescanning…"),
QT_TRANSLATE_NOOP("bitnova-core", "SQLiteDatabase: Failed to execute statement to verify database: %s"),
QT_TRANSLATE_NOOP("bitnova-core", "SQLiteDatabase: Failed to prepare statement to verify database: %s"),
QT_TRANSLATE_NOOP("bitnova-core", "SQLiteDatabase: Failed to read database verification error: %s"),
QT_TRANSLATE_NOOP("bitnova-core", "SQLiteDatabase: Unexpected application id. Expected %u, got %u"),
QT_TRANSLATE_NOOP("bitnova-core", "Section [%s] is not recognized."),
QT_TRANSLATE_NOOP("bitnova-core", "Settings file could not be read"),
QT_TRANSLATE_NOOP("bitnova-core", "Settings file could not be written"),
QT_TRANSLATE_NOOP("bitnova-core", "Signer did not echo address"),
QT_TRANSLATE_NOOP("bitnova-core", "Signer echoed unexpected address %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Signer returned error: %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Signing transaction failed"),
QT_TRANSLATE_NOOP("bitnova-core", "Specified -walletdir \"%s\" does not exist"),
QT_TRANSLATE_NOOP("bitnova-core", "Specified -walletdir \"%s\" is a relative path"),
QT_TRANSLATE_NOOP("bitnova-core", "Specified -walletdir \"%s\" is not a directory"),
QT_TRANSLATE_NOOP("bitnova-core", "Specified blocks directory \"%s\" does not exist."),
QT_TRANSLATE_NOOP("bitnova-core", "Specified data directory \"%s\" does not exist."),
QT_TRANSLATE_NOOP("bitnova-core", "Starting network threads…"),
QT_TRANSLATE_NOOP("bitnova-core", "System error while flushing: %s"),
QT_TRANSLATE_NOOP("bitnova-core", "System error while loading external block file: %s"),
QT_TRANSLATE_NOOP("bitnova-core", "System error while saving block to disk: %s"),
QT_TRANSLATE_NOOP("bitnova-core", "The source code is available from %s."),
QT_TRANSLATE_NOOP("bitnova-core", "The specified config file %s does not exist"),
QT_TRANSLATE_NOOP("bitnova-core", "The transaction amount is too small to pay the fee"),
QT_TRANSLATE_NOOP("bitnova-core", "The transactions removal process can only be executed within a db txn"),
QT_TRANSLATE_NOOP("bitnova-core", "The wallet will avoid paying less than the minimum relay fee."),
QT_TRANSLATE_NOOP("bitnova-core", "There is no ScriptPubKeyManager for this address"),
QT_TRANSLATE_NOOP("bitnova-core", "This is experimental software."),
QT_TRANSLATE_NOOP("bitnova-core", "This is the minimum transaction fee you pay on every transaction."),
QT_TRANSLATE_NOOP("bitnova-core", "This is the transaction fee you will pay if you send a transaction."),
QT_TRANSLATE_NOOP("bitnova-core", "Transaction %s does not belong to this wallet"),
QT_TRANSLATE_NOOP("bitnova-core", "Transaction amount too small"),
QT_TRANSLATE_NOOP("bitnova-core", "Transaction amounts must not be negative"),
QT_TRANSLATE_NOOP("bitnova-core", "Transaction change output index out of range"),
QT_TRANSLATE_NOOP("bitnova-core", "Transaction must have at least one recipient"),
QT_TRANSLATE_NOOP("bitnova-core", "Transaction needs a change address, but we can't generate it."),
QT_TRANSLATE_NOOP("bitnova-core", "Transaction too large"),
QT_TRANSLATE_NOOP("bitnova-core", "Unable to bind to %s on this computer (bind returned error %s)"),
QT_TRANSLATE_NOOP("bitnova-core", "Unable to bind to %s on this computer. %s is probably already running."),
QT_TRANSLATE_NOOP("bitnova-core", "Unable to create the PID file '%s': %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Unable to find UTXO for external input"),
QT_TRANSLATE_NOOP("bitnova-core", "Unable to generate initial keys"),
QT_TRANSLATE_NOOP("bitnova-core", "Unable to generate keys"),
QT_TRANSLATE_NOOP("bitnova-core", "Unable to open %s for writing"),
QT_TRANSLATE_NOOP("bitnova-core", "Unable to parse -maxuploadtarget: '%s'"),
QT_TRANSLATE_NOOP("bitnova-core", "Unable to start HTTP server. See debug log for details."),
QT_TRANSLATE_NOOP("bitnova-core", "Unable to unload the wallet before migrating"),
QT_TRANSLATE_NOOP("bitnova-core", "Unknown -blockfilterindex value %s."),
QT_TRANSLATE_NOOP("bitnova-core", "Unknown address type '%s'"),
QT_TRANSLATE_NOOP("bitnova-core", "Unknown change type '%s'"),
QT_TRANSLATE_NOOP("bitnova-core", "Unknown network specified in -onlynet: '%s'"),
QT_TRANSLATE_NOOP("bitnova-core", "Unknown new rules activated (versionbit %i)"),
QT_TRANSLATE_NOOP("bitnova-core", "Unrecognised option \"%s\" provided in -test=<option>."),
QT_TRANSLATE_NOOP("bitnova-core", "Unsupported global logging level %s=%s. Valid values: %s."),
QT_TRANSLATE_NOOP("bitnova-core", "Unsupported logging category %s=%s."),
QT_TRANSLATE_NOOP("bitnova-core", "User Agent comment (%s) contains unsafe characters."),
QT_TRANSLATE_NOOP("bitnova-core", "Verifying blocks…"),
QT_TRANSLATE_NOOP("bitnova-core", "Verifying wallet(s)…"),
QT_TRANSLATE_NOOP("bitnova-core", "Wallet file creation failed: %s"),
QT_TRANSLATE_NOOP("bitnova-core", "Wallet needed to be rewritten: restart %s to complete"),
QT_TRANSLATE_NOOP("bitnova-core", "acceptstalefeeestimates is not supported on %s chain."),
>>>>>>> 5360f2baff (Initialized BitNova project)
};
