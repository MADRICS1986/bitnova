...
=======
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bitnova address to send to."},
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
                                         "The recipient will receive less bitnovas than you enter in the amount field."},
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
                            {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO, "The bitnova address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value"},
>>>>>>> 5360f2baff (Initialized BitNova project)
                        },
                    },
...
=======
                                       "Those recipients will receive less bitnovas than you enter in their corresponding amount field.\n"
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Change address must be a valid bitnova address");
>>>>>>> 5360f2baff (Initialized BitNova project)
            }
...
=======
                            {"changeAddress", RPCArg::Type::STR, RPCArg::DefaultHint{"automatic"}, "The bitnova address to receive the change"},
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
                {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO, "A key-value pair. The key (string) is the bitnova address,\n"
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
                    {"change_address", RPCArg::Type::STR, RPCArg::DefaultHint{"automatic"}, "The bitnova address to receive the change"},
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "A bitnova address which receives an equal share of the unspecified amount."},
                    {"", RPCArg::Type::OBJ_USER_KEYS, RPCArg::Optional::OMITTED, "",
                        {
                            {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO, "A key-value pair. The key (string) is the bitnova address, the value (float or string) is the amount in " + CURRENCY_UNIT + ""},
>>>>>>> 5360f2baff (Initialized BitNova project)
                        },
                    },
                },
