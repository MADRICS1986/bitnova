...
=======
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The bitnova address for transactions."},
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
                "A locked transaction output will not be chosen by automatic coin selection, when spending bitnovas.\n"
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
                    {"addresses", RPCArg::Type::ARR, RPCArg::Default{UniValue::VARR}, "The bitnova addresses to filter",
                        {
                            {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "bitnova address"},
>>>>>>> 5360f2baff (Initialized BitNova project)
                        },
                    },
...
=======
                            {RPCResult::Type::STR, "address", /*optional=*/true, "the bitnova address"},
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid BitNova address: ") + input.get_str());
>>>>>>> 5360f2baff (Initialized BitNova project)
            }
