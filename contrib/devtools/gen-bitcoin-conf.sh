...
=======
BITCOIND=${BITCOIND:-$BINDIR/bitnovad}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/bitnova.conf}
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
  echo -e "To safely generate a bitnova.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example bitnova.conf file in share/examples/'
>>>>>>> 5360f2baff (Initialized BitNova project)
...
## Generated by contrib/devtools/gen-bitnova-conf.sh.
>>>>>>> 5360f2baff (Initialized BitNova project)
##
...
=======
# parse the output from bitnovad --help
>>>>>>> 5360f2baff (Initialized BitNova project)
