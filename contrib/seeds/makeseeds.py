...
=======
    argparser = argparse.ArgumentParser(description='Generate a list of bitnova node seed ip addresses.')
>>>>>>> 5360f2baff (Initialized BitNova project)
...
=======
    # Filter out hosts with multiple bitnova ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple bitnova ports', file=sys.stderr)
>>>>>>> 5360f2baff (Initialized BitNova project)
